...
interface RHQLicenseStepperProps {
  steps: Step[];
...
export const RHQLicenseStepper: React.FC<RHQLicenseStepperProps> = ({
  steps,
  activeStep,
}) => {
  return (
    <Container>
      <TitleWrapper>
        ...
        <Title>RHQ License</Title> {/* Updated title */}
      </TitleWrapper>
      <StepsContainer>
...
export default RHQLicenseStepper;
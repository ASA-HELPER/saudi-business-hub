...
interface StrategicInvestorStepperProps {
  steps: Step[];
...
export const StrategicInvestorStepper: React.FC<
  StrategicInvestorStepperProps
> = ({ steps, activeStep }) => {
...
export default StrategicInvestorStepper;
